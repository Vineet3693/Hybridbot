...
<style>
body, .stApp {
    background: linear-gradient(135deg, #021B79 0%, #0575E6 33%, #00C9A7 66%, #0f2027 100%);
...
.rgb-header {
    ...
    box-shadow: 0 6px 24px 0 rgba(2,27,121,0.22);
...
.rgb-title {
    ...
    font-weight: 700;
    letter-spacing: 2px;
    background: linear-gradient(90deg,#00c9a7,#0575e6,#021b79);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    animation: glow 1.5s infinite alternate;
}
@keyframes glow {
    0% { text-shadow: 0 0 16px #00c9a7, 0 0 8px #0575e6;}
    100% { text-shadow: 0 0 24px #0575e6, 0 0 12px #00c9a7;}
}
.rgb-subtitle {
    color: #b0f0e6;
    font-size: 1.1rem;
    ...
    margin-top: 0.5rem;
    letter-spacing: 1px;
    text-shadow: 0 2px 16px #021b7922;
}
.chat-message {
    ...
    padding: 1.2rem;
    border-radius: 16px;
    box-shadow: 0 2px 10px 0 #021b7922;
    transition: box-shadow 0.3s;
    color: #f8f8f8;
}
.chat-message:hover {
    box-shadow: 0 8px 32px 0 #00c9a733;
}
.source-box {
    background: linear-gradient(90deg,#e0f7fa88,#b2ebf288);
...
.stTextInput > div > input {
    background-color: #01131e !important;
    color: #b0f0e6 !important;
}
.stTextInput > label {
    color: #b0f0e6 !important;
}
.stButton > button {
    background: linear-gradient(90deg,#0575e6,#00c9a7 90%);
    color: #fff;
    border-radius: 8px;
    font-weight: 600;
}
.stButton > button:hover {
    background: linear-gradient(90deg,#021b79,#0575e6 90%);
}
</style>
""", unsafe_allow_html=True)
